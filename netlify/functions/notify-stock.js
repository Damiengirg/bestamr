// netlify/functions/notify-stock.js
// Enregistre les emails pour notification de réappro
// → t'envoie un email pour t'informer qu'un client attend
...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Notification email à toi via Resend
